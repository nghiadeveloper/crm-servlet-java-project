				...
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="date" value="${project.startDate}"
											name="DateStart" class="form-control form-control-line">
										<c:if test="${not empty errorDateS }">
											<span style="color: red">${errorDateS}</span>
										</c:if>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="date" value="${project.endDate}" name="DateEnd"
											class="form-control form-control-line">
										<c:if test="${not empty errorDateE }">
											<span style="color: red">${errorDateE}</span>
										</c:if>
									</div>
								</div>
								<div class="form-group">
							...
							<c:if test="${not empty errSetDateTime }">
								<span style="color: red">${errSetDateTime}</span>
								</br>
							</c:if>
							...
							<c:if test="${not empty isSuccess}">
								...
								<c:if test="${!isSuccess}">
									<span style="color: red">Cập nhật không thành công</span>
								</c:if>
							</c:if>
						</div>
					</div>
