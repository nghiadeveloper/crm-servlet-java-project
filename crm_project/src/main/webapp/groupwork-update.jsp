			...
			<div class="container-fluid">
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">Chỉnh sữa dự án</h4>
					</div>
				</div>
				<!-- /.row -->
				<!-- .row -->
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form action="groupwork-update" method="post" class="form-horizontal form-material">
								<div class="form-group">
									<label class="col-md-12">Tên dự án</label>
									<div class="col-md-12">
										<input type="text" value="${project.name}" name="GWName"
								...
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="date" value="${project.startDate}" name="DateStart"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-12">
										<input type="date" value="${project.endDate}" name="DateEnd"
											class="form-control form-control-line">
									</div>
								</div>
								<div class="form-group">
