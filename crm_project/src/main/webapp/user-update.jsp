		...
		<nav class="navbar navbar-default navbar-static-top m-b-0">
			<div class="navbar-header">
				<a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)"
					data-toggle="collapse" data-target=".navbar-collapse"> <i class="fa fa-bars"></i>
				</a>
				<div class="top-left-part">
					<a class="logo" href="index.html"> <b> <img src="plugins/images/pixeladmin-logo.png"
								alt="home" />
						</b> <span class="hidden-xs"> <img src="plugins/images/pixeladmin-text.png"
								alt="home" />
						</span>
					</a>
				</div>
					...
					<li>
						<div class="dropdown">
							<a class="profile-pic dropdown-toggle" data-toggle="dropdown" href="#"> <img
									...
									class="img-circle" /> <b class="hidden-xs">Cybersoft</b>
							</a>
			...
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					...
					<li><a href="/crm_project_02/groupwork" class="waves-effect"><i
								class="fa fa-table fa-fw" aria-hidden="true"></i><span class="hide-menu">Dự
								án</span></a></li>
			...
			<div class="container-fluid">
				<div class="row bg-title">
					<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
						<h4 class="page-title">Chỉnh sữa thành viên</h4>
					</div>
				</div>
				<!-- /.row -->
				<!-- .row -->
				<div class="row">
					...
					<div class="col-md-8 col-xs-12">
						<div class="white-box">
							<form action="user-update" class="form-horizontal form-material" method="post">
								<div class="form-group">
									<label class="col-md-12">Full Name</label>
									<div class="col-md-12">
										<input type="text" value="${user.fullName}" name="fullName"
											class="form-control form-control-line"> <input type="hidden"
											value="${user.id}" name="id_user">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-12">
										<select class="form-control form-control-line" name="role">
											<c:forEach items="${listRole}" var="items">
												<option value="${items.id}" <c:if test="${items.id eq user.role_id.id}">selected="selected"</c:if>">${items.name}</option>
											</c:forEach>
										</select>
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
										<button type="submit" class="btn btn-success">UpdateUser</button>
										<a href="<c:url value='/user' />" class="btn btn-primary">Quaylại</a>
									</div>
								</div>
							</form>
							<c:if test="${not empty isSuccess}">
								<span style="color: green">${isSuccess}</span>
							</c:if>
						</div>
					</div>
					<div class="col-md-2 col-12"></div>
