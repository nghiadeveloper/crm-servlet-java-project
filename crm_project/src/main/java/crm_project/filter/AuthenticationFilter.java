...
@WebFilter(filterName = "authenticationFilter", urlPatterns = { "/user", "/user-add", "/user-details", "/role-table",
		"/role-add", "/task", "/task-add", "/profile", "/profile-edit", "/groupwork", "/groupwork-add",
		"/groupwork-details" })
public abstract class AuthenticationFilter implements Filter {
	...
	public void doFilter(ServletRequest sevlReq, ServletResponse sevlRes, FilterChain chain) throws IOException, ServletException {
	...
	private void checkRole(String role, List<String> allowedRole, FilterChain chain, HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
